export const siteConfig = {
  ...
  description:
    "Club équestre Fort Apache à Vence (06140), quartier Col de Vens : balades à poney, cours d'équitation, stages, randonnées et compétitions. Ouvert tous les jours de 10h à 17h.",
  ...
  contact: {
    ...
    address: {
      street: '75 route de Saint-Barnabé, quartier Col de Vens',
      locality: 'Vence',
